                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="container">
                            <div class="banner-two__content">
                                ...
                                <h1 data-animation="fadeInUp" data-delay="1.3s">Satisfy all your  <br>
                                     <span class="primary-color">cigar needs!</span></h1>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="container">
                            <div class="banner-two__content">
                                <h4 data-animation="fadeInUp" data-delay="1s"><img src="assets/images/icon/fire.svg"
                                        alt="icon"> GET <span class="primary-color">25% OFF</span> NOW</h4>
                                <h1 data-animation="fadeInUp" data-delay="1.3s">Everything you need   <br>
                                    for <span class="primary-color">Hookah!</span></h1>
                                <p class="mt-40" data-animation="fadeInUp" data-delay="1.5s"></p>
                                <div class="banner-two__info mt-30" data-animation="fadeInUp" data-delay="1.7s">
                                    <span class="mb-10">Starting Price</span>
                                    <h3>$29.00</h3>
                        ...
                        <div class="container">
                            <div class="banner-two__content">
                                <h4 data-animation="fadeInUp" data-delay="1s"><img src="assets/images/icon/fire.svg"
                                        alt="icon"> GET <span class="primary-color">25% OFF</span> NOW</h4>
                                <h1 data-animation="fadeInUp" data-delay="1.3s">Satisfy all your <br>
                                     <span class="primary-color">Tobacco needs!</span></h1>
                                <p class="mt-40" data-animation="fadeInUp" data-delay="1.5s"></p>
                                <div class="banner-two__info mt-30" data-animation="fadeInUp" data-delay="1.7s">
                                    <span class="mb-10">Starting Price</span>
                                    <h3>$15.00</h3>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    ...
                                    <h4 class="mt-30"><a href="javascript:">Pipe Tobacco</a></h4>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                            ...
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    ...
                                    <h4 class="mt-30"><a href="shop.html">Grinders</a></h4>
                                </div>
                            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".1s">
                        <div class="view__left-item">
                            <div class="image">
                                <img src="assets/images/view/view-image1.png" alt="image">
                            </div>
                            <div class="view__left-content sub-bg">
                                <h2><a class="primary-hover" href="javascript:">BLINK TORCH SPECIAL EDITION</a>
                                </h2>
                                <p class="fw-600">The torch boasts a sleek and eye-catching design that elevates your experience.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="view__item mb-25 wow fadeInDown" data-wow-delay=".2s">
                            <div class="view__content">
                                <h3><a class="primary-hover" href="javascript:">Blink Tera </a></h3>
                                <p>If "Blink Tera" is a new product, you might find information on retail websites.</p>
                                <a class="btn-two" href="javascript:"><span>Shop Now</span></a>
                            </div>
                            <div class="view__image">
                                <img src="assets/images/view/view-image2.png" alt="image">
                            </div>
                        </div>
