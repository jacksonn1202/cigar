    ...
    <main>
        ...
        <section class="banner-two">
            <!-- <div class="banner-two__shape-left d-none d-lg-block wow bounceInLeft" data-wow-duration="1s"
                data-wow-delay=".5s">
                <img src="assets/images/shape" alt="shape">
            </div> -->
            ...
            <div class="swiper banner-two__slider">
                ...
                <div class="swiper-slide">
                        <div class="slide-bg" data-background="assets/images/banner/banner-1.jpg"></div>
                        <div class="container">
                            <div class="banner-two__content">
                                <h4 data-animation="fadeInUp" data-delay="1s"><img src="assets/images/icon/fire.svg"
                                        alt="icon"> Premium <span class="primary-color">Cigar</span> Collection</h4>
                                        <h2 data-animation="fadeInUp" data-delay="1.3s">From classics to rarities,  <br>
                                     <span class="primary-color">find your ideal cigar here.</span></h2>
                                <p class="mt-40" data-animation="fadeInUp" data-delay="1.5s"></p>
                                ...
                                <div class="btn-wrp mt-65">
                                    <a href="javascript:" class="btn-one" data-animation="fadeInUp"
                                        data-delay="1.8s"><span>Shop
                                            Now</span></a>
                                    <a class="btn-one-light ml-20" href="javascript" data-animation="fadeInUp"
                    ...
                    <div class="swiper-slide">
                        <div class="slide-bg" data-background="assets/images/banner/banner-5.jpg"></div>
                        <div class="container">
                            <div class="banner-two__content">
                            <h4 data-animation="fadeInUp" data-delay="1s"><img src="assets/images/icon/fire.svg"
                                        alt="icon"> Premium <span class="primary-color">Cigar</span> Collection</h4>
                                        ...
                                        <h2 data-animation="fadeInUp" data-delay="1.3s">A journey of taste begins   <br>
                                with <span class="primary-color">our handpicked cigars.!</span></h2>
                                <p class="mt-40" data-animation="fadeInUp" data-delay="1.5s"></p>
                                <div class="banner-two__info mt-30" data-animation="fadeInUp" data-delay="1.7s">
                                    <span class="mb-10">Starting Price</span>
                                    <h3>$500.00</h3>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-bg" data-background="assets/images/banner/banner-4.jpg"></div>
                        <div class="container">
                            <div class="banner-two__content">
                            <h4 data-animation="fadeInUp" data-delay="1s"><img src="assets/images/icon/fire.svg"
                                        alt="icon"> Premium <span class="primary-color">Cigar</span> Collection</h4>
                                <h2 data-animation="fadeInUp" data-delay="1.3s">Satisfy all your <br>
                                     <span class="primary-color">Tobacco needs!</span></h2>
                                <p class="mt-40" data-animation="fadeInUp" data-delay="1.5s"></p>
                                <div class="banner-two__info mt-30" data-animation="fadeInUp" data-delay="1.7s">
                                    <span class="mb-10">Starting Price</span>
                                    <h3>$500.00</h3>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="javascript:" class="category__image d-block">
                                        <img src="assets/images/category/category-image1.png" alt="image">
                                        <div class="category-icon">
                                            <img src="assets/images/category/cigar.png" alt="icon" style="height:80px;width:80px">
                                        </div>
                                    </a>
                                    <h4 class="mt-30"><a href="javascript:">Cigar</a></h4>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        ...
                                        <div class="category-icon">
                                            <img src="assets/images/category/hookah.png" alt="icon" style="height:80px;width:80px">
                                        </div>
                                    </a>
                                    <h4 class="mt-30"><a href="shop.html">Hookah</a></h4>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        ...
                                        <div class="category-icon">
                                            <img src="assets/images/category/zippo.png" alt="icon" style="height:80px;width:80px">
                                        </div>
                                    </a>
                                    <h4 class="mt-30"><a href="shop.html">Zippo</a></h4>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        ...
                                        <div class="category-icon">
                                            <img src="assets/images/category/paper-roll.png" alt="icon" style="height:80px;width:80px">
                                        </div>
                                    </a>
                                    <h4 class="mt-30"><a href="shop.html">Rolling Papers</a></h4>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        ...
                                        <div class="category-icon">
                                            <img src="assets/images/category/flashlight.png" alt="icon" style="height:80px;width:80px">
                                        </div>
                                    </a>
                                    <h4 class="mt-30"><a href="shop.html">Torches</a></h4>
                                </div>
                            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".1s">
                        <div class="view__left-item">
                            <div class="image">
                                <img src="assets/images/view/hookah-still-life-arrangement.jpg" alt="image">
                            </div>
                            <div class="view__left-content sub-bg">
                                <h2><a class="primary-hover" href="javascript:">HOOKAH <br>SPECIAL EDITION</a>
                                </h2>
                                <p class="fw-600">Unleash Exotic Flavors with Our Premium Hookahs.</p>
                                <a class="btn-two" href="javascript:"><span>Shop Now</span></a>
                                <a class="off-btn" href="#0"><img class="mr-10" src="assets/images/icon/fire.svg"
                                        alt="icon"> Premium
                                    <span class="primary-color">Hookah</span> Collection</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="view__item mb-25 wow fadeInDown" data-wow-delay=".2s">
                            <div class="view__content">
                                <h3><a class="primary-hover" href="javascript:">CIgar Cutter </a></h3>
                                <p>Crafted for aficionados: Experience <br>the perfect cut every time with our <br>premium cigar cutter, a blend of <br>elegance and functionality.</p>
                                <a class="btn-two" href="javascript:"><span>Shop Now</span></a>
                            </div>
                            <div class="view__image">
                                <img src="assets/images/product/cigar-cutter.jpg" alt="image" style="height:180px;">
                            </div>
                        </div>
                        <div class="view__item wow fadeInUp" data-wow-delay=".3s">
                            <div class="view__content">
                                <h3><a class="primary-hover" href="javascript:">Shop Premium Cigars</a></h3>
                                <p>Explore and Shop Premium Cigars for an Unmatched Smoking Experience</p>
                                <a class="btn-two" href="javascript:"><span>Shop Now</span></a>
                            </div>
                            <div class="view__image">
                                <img src="assets/images/view/view-image3.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    ...
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-2.png"
                                            alt="image">
                                        <img class="back-image" src="assets/images/product/product-1.png"
                                            alt="image" style="height:290px;width:380px">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">LA AURORA</a></h4>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-4.png"
                                            alt="image" style="height:290px;">
                                        <img class="back-image" src="assets/images/product/product-3.png"
                                            alt="image" style="height:320px;width:350px">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Camacho</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-6.png"
                                            alt="image">
                                        <img class="back-image" src="assets/images/product/product-5.png"
                                            alt="image">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Arturo Fuente</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-7.png"
                                            alt="image">
                                        <img class="back-image" src="assets/images/product/product-8.png"
                                            alt="image">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Brazzilian Times 3</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-9.png"
                                            alt="image">
                                        <img class="back-image" src="assets/images/product/product-10.png"
                                            alt="image">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Acid Kuba</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-11.png"
                                            alt="image">
                                        <img class="back-image" src="assets/images/product/product-12.jpg"
                                            alt="image">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Partagas</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-13.png"
                                            alt="image">
                                        <img class="back-image" src="assets/images/product/product-14.png"
                                            alt="image">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Romeo Y Julieta</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-6">
                                <div class="product__item bor">
                                    <a href="#0" class="wishlist"><i class="fa-regular fa-heart"></i></a>
                                    <a href="shop-single.html" class="product__image pt-20 d-block">
                                        <img class="font-image" src="assets/images/product/product-15.png"
                                            alt="image" style="height: 280px;">
                                        <img class="back-image" src="assets/images/product/product-16.png"
                                            alt="image">
                                    </a>
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="shop-single.html">Ashton</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                    ...
                    <div class="col-lg-6">
                        <div class="discount__item ps-0 pb-5 pb-lg-0 ps-lg-5">
                            <div class="section-header">
                                ...
                                <p class="mt-30 mb-55 wow fadeInUp" data-wow-delay=".2s">Choose a size that suits your preferences. Larger hookahs may provide a different smoking experience than smaller ones.
                                   
                                </p>
                                <a class="btn-one wow fadeInUp" data-wow-delay=".3s" href="javascript:"><span>Shop
                                        Now</span></a>
        ...
        <div class="marquee-wrapper text-slider">
            <div class="marquee-inner to-left">
                <ul class="marqee-list d-flex">
                    ...
                    Pipe Tobacco <img src="assets/images/icon/title-left.svg" alt="icon"> <span>Hookah</span>
                        <img src="assets/images/icon/title-left.svg" alt="icon">
                        Zippo <img src="assets/images/icon/title-left.svg" alt="icon"> <span>Rolling Papers</span>
                        <img src="assets/images/icon/title-left.svg" alt="icon">
                        Grinders <img src="assets/images/icon/title-left.svg" alt="icon"> <span>Cigars</span>
                        <img src="assets/images/icon/title-left.svg" alt="icon">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="javascript:">best e-lequid</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="javascript:" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="javascript:">best vape flavours</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="javascript:" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="javascript:">Battery And Charger Kit</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="javascript:" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="javascript:">best vape tanks</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="javascript:" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="javascript:">POP Extra Strawberry</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="javascript:" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
